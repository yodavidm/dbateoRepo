	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http
				...
				.authorizeHttpRequests(authRequest->authRequest
						...
						.requestMatchers("/auth/**","/validar","/publicaciones","/user/{id}","/publicaciones/{id}","/publicaciones/categoria/{id}","/comentarios","/comentarios/publicacion/{id}","/seguidores/**").permitAll()  //Aqui ire todas las rutas publicas
